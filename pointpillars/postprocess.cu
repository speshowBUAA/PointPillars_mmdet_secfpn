...
void PostprocessCuda::DoPostprocessCuda(
    ...
    for (int class_idx = 0; class_idx < num_class_; ++ class_idx) {  // hardcode for class_map as {0, 12 , 34 , 5 ,67 ,89}
        ...
        for (int ith_box = 0 ; ith_box  < host_filtered_count[class_idx] ; ++ith_box) 
        {
            ...
            // printf("%f %f %f %f %f %f %f\n", host_sorted_filtered_box[ith_box*7], host_sorted_filtered_box[ith_box*7 + 1],
            //     host_sorted_filtered_box[ith_box*7 + 2], host_sorted_filtered_box[ith_box*7 + 3], host_sorted_filtered_box[ith_box*7 + 4],
            //     host_sorted_filtered_box[ith_box*7 + 5], host_sorted_filtered_box[ith_box*7 + 6]);
        }

        // printf("Fuck \n");
        // for(int i = 0; i< 4; i++)
        // {  
        //     printf("%f %f %f %f %f %f %f\n", host_sorted_filtered_box[i*7], host_sorted_filtered_box[i*7 + 1],
        //         host_sorted_filtered_box[i*7 + 2], host_sorted_filtered_box[i*7 + 3], host_sorted_filtered_box[i*7 + 4],
        //         host_sorted_filtered_box[i*7 + 5], host_sorted_filtered_box[i*7 + 6]);
        // }
        ...
        // for(int i = 0; i< 4; i++)
        // {  
        //     printf("%f %f %f %f %f %f %f\n", host_sorted_filtered_box[keep_inds[i]*7], host_sorted_filtered_box[keep_inds[i]*7 + 1],
        //         host_sorted_filtered_box[keep_inds[i]*7 + 2], host_sorted_filtered_box[keep_inds[i]*7 + 3], host_sorted_filtered_box[keep_inds[i]*7 + 4],
        //         host_sorted_filtered_box[keep_inds[i]*7 + 5], host_sorted_filtered_box[keep_inds[i]*7 + 6]);
        // }
        // exit(0);
        GPU_CHECK(cudaFree(dev_sorted_filtered_box));
        GPU_CHECK(cudaFree(dev_sorted_filtered_score));
